...
ko.bindingHandlers.map = {
    init: function init(element, valueAccessor, allBindings) {
        ...
        var zoom = allBindings.get('mapZoom') || 11;
        var lat = allBindings.get('mapCenterLat') || 37.8271784;
        var lng = allBindings.get('mapCenterLng') || -122.2913078;
        ...
        if (valueUnwrapped === undefined) {
            ...
            var _map = new google.maps.Map(element, options);
        }
    }
};
